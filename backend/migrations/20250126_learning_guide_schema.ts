// Migration: Learning Guide Schema
// Creates tables for AI-Powered Learning Guide system

import { Migration } from '../types';
import PocketBase from 'pocketbase';

export const migration_20250126_learning_guide_schema: Migration = {
  id: '20250126_learning_guide_schema',
  name: 'Create Learning Guide Schema',
  timestamp: 20250126000000,
