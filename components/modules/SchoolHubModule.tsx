...
// Parent
import ParentHome from './school-hub/parent/Home'; // New
import ChildsProgress from './school-hub/parent/ChildsProgress';
import ParentCommunication from './school-hub/parent/ParentCommunication';
...
const SchoolHubModule: React.FC = () => {
  const [activeL1, setActiveL1] = useState<L1Tab>('School');
  const [activeReportId, setActiveReportId] = useState<string>(schoolHubData.School[0].id);
